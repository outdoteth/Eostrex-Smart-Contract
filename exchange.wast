(module
 ...
 (data (i32.const 672) "Invalid buy_or_sell parameter: Must be either 1 (buy) or 0 (sell)\00")
 (data (i32.const 752) "It appears as though you have not deposited any EOS from eosio.token!\00")
 (data (i32.const 832) "Insufficient EOS balance!\00")
 (data (i32.const 864) "It appears as though you have not deposited any tokens from the given contract!\00")
 (data (i32.const 944) "comparison of assets with different symbols is not allowed\00")
 (data (i32.const 1008) "Insufficient token balance!\00")
 ...
 (data (i32.const 1232) "Overflow error: Amount of token must be greater than 0 and less than the order amount\00")
 (data (i32.const 1328) "The order_id you entered does not exist!\00")
 (data (i32.const 1376) "You do not have any EOS\00")
 (data (i32.const 1408) "You do not have the given asset\00")
 ...
 (data (i32.const 1616) "You do not have any available balances\00")
 (data (i32.const 1664) "You do not have enough of the given asset\00")
 (data (i32.const 1712) "active\00")
 (data (i32.const 1728) "transfer\00")
 (data (i32.const 1744) "Withdraw from eostrader\00")
 (data (i32.const 1776) "Could not find the specified order\00")
